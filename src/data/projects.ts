...
export const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      `${imageBase}images/vitoria/futebol/IMG_0506.JPG.jpeg`,
      `${imageBase}images/vitoria/futebol/IMG_0507.JPG.jpeg`,
    ],
  },
  {
    id: 2,
    ...
    gallery: [
      ...
      `${imageBase}images/vitoria/igreja/IMG_7666.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7667.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7672.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7673.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7675.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7677.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7678.JPEG`,
      `${imageBase}images/vitoria/igreja/IMG_7679.JPEG`,
    ],
  },
  {
    id: 3,
    ...
    gallery: [
      ...
      `${imageBase}images/vitoria/batizado/IMG_0544.JPEG`,
      `${imageBase}images/vitoria/batizado/IMG_0545.JPEG`,
      ...
      `${imageBase}images/vitoria/batizado/IMG_0550.JPEG`,
      `${imageBase}images/vitoria/batizado/IMG_0551.JPEG`,
      `${imageBase}images/vitoria/batizado/IMG_0552.JPEG`,
      `${imageBase}images/vitoria/batizado/IMG_0553.JPEG`,
      `${imageBase}images/vitoria/batizado/IMG_0554.JPEG`,
    ],
  },
];
